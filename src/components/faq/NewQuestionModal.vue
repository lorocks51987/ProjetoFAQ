      ...
      <form @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <div class="space-y-4">
          ...
          <div class="flex gap-4">
            <!-- Opção Serviços -->
            <div class="flex-1 p-6 rounded-lg border-2 cursor-pointer transition-all duration-300" :class="[
              ...
              <div class="flex items-center space-x-4">
                <div class="w-6 h-6 rounded-full border-2 flex items-center justify-center" :class="[
                  ...
                  <div v-if="formData.tipo === 'servicos'" class="w-3 h-3 bg-[#00FF88] rounded-full"></div>
                </div>
                <div>
            ...
            <div class="flex-1 p-6 rounded-lg border-2 cursor-pointer transition-all duration-300" :class="[
              ...
              <div class="flex items-center space-x-4">
                <div class="w-6 h-6 rounded-full border-2 flex items-center justify-center" :class="[
                  ...
                  <div v-if="formData.tipo === 'produto'" class="w-3 h-3 bg-[#00FF88] rounded-full"></div>
                </div>
                <div>
        ...
        <div v-if="formData.tipo === 'produto'" class="space-y-3">
          ...
          <select v-model="formData.produtoId" class="w-full px-6 py-3 bg-[#0a0a0a] text-white rounded-lg 
    ...
    async handleSubmit() {
      ...
      try {
        const questionData = {
          ...
          productId: this.formData.produtoId,
          question: this.formData.question,
          author: this.formData.autor
        }

        await faqService.createQuestion(questionData)
